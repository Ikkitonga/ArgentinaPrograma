...
function obtenerJugadaUsuario() {
  ...
  while (true) {
    movimientoJugador = readline.question("Elige tu jugada: piedra, papel o tijeras: ").toLowerCase().trim();
...
function jugar(){
  ...
  let partidos = parseInt(readline.question('Cuantos partidos quieres realizar?: '));
